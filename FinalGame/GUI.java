 ...
 * @author Louis Weyland based on  cambolbro (based on code from previous years).
 *
...
class EmeraldMinePanel extends JPanel 
{
     ...
     */
    public synchronized void redrawWorld(final World world)
    {
...
class GUI 
{
    ...
    public void redraw(){       // creat a method redraw which is called by the simultor thread so that it will redraw the world without the move of the player
        panel.redrawWorld(world);
    }
